$(document).ready(function() {
  ...
  var bounds_route = new L.featureGroup([]);
  var img_route = 'img/route.jpg';
  var img_bounds_route = [
    [51.60438656606835, 5.4099610135234615],
    [51.60609895231536, 5.414622058159905]
  ];
  var layer_route = new L.imageOverlay(img_route, img_bounds_route);
  bounds_route.addLayer(layer_route);
  ...
  var overlayLagen = {
    ...
    'Platteground Het Verhaal': layer_route
  };
